...
<!-- <nav class="navbar navbar-expand-md navbar-light " style="background:#8432DF;">
    ...
    <div class="text-center col-sm m-0 m" > 
       ...
       <button type="button" name="back" class="btn mt-4  p-2 btn-danger" style="margin-left:-80%"><a href="s_dashboard.php" class="text-white"><i class="bi-arrow-left-circle-fill"></i>GoBack</a></button>
    </div>
