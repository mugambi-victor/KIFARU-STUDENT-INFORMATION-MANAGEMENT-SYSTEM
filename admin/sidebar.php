        ...
        <div class="col-md-2 " id="collapseExample">
            ...
            <li class="  nav-item ">
                ...
                <li class="nav-item text-uppercase  dropdown">
                    ...
                    <a href="createdepartment" class="dropdown-item">Academic Year & DEPARTMENTS </a>
                        <a href="classs" class="dropdown-item">Courses</a>
                        <a href="classs" class="dropdown-item">units</a>
